...
def main(host):
    ...
    def increment_and_check_errors():
        nonlocal error_count
        error_count += 1
        if error_count >= MAX_ERRORS:
            print(f"\n {MAX_ERRORS} Errors Reached. The environment is likely broken.")
            print(" Aborting evaluation to save time and fail the CI pipeline.")
            sys.exit(1) # This forces the Makefile/CI to fail immediately!
    # -----------------------
